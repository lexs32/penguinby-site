...
export const products = [
  {
    ...
    pricing: [
      { label: "1 Day", price: "$7.99", period: "/ day", url: "https://penguinby.dev/" },
      { label: "1 Week", price: "$24.99", period: "/ week", url: "https://penguinby.dev/" },
      { label: "1 Month", price: "$49.99", period: "/ month", url: "https://penguinby.dev/" },
    ],
  ...
  },
  {
    ...
    pricing: [
      { label: "1 Day", price: "$6.99", period: "/ day", url: "https://penguinby.dev/" },
      { label: "1 Week", price: "$24.99", period: "/ week", url: "https://penguinby.dev/" },
      { label: "1 Month", price: "$49.99", period: "/ month", url: "https://penguinby.dev/" },
    ],
